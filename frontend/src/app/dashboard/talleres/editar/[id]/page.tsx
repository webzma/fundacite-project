  ...
  useEffect(() => {
    ...
    if (course) {
      setFormData({
        ...
        capacity: course.capacity ? course.capacity.toString() : "",
      });
    } else {
  ...
  return (
    <div>
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl md:text-3xl font-bold">Editar Taller</h1>
      </div>
      ...
      <Card className="shadow-sm">
        <form onSubmit={handleSubmit}>
          <CardHeader className="pb-4">
            ...
            <CardDescription>
              Actualiza la información del taller o curso.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="students">Estudiantes inscritos</Label>
              <Input
                id="students"
                name="students"
                type="number"
