...
import { BookOpen, Home, LogOut, Menu, X, BarChart3, Settings, HelpCircle, Calendar } from "lucide-react"
...
export function DashboardSidebar() {
  ...
  const secondaryNavigation = [{ name: "Ayuda", href: "/dashboard/ayuda", icon: HelpCircle, disabled: false }]
          ...
          <div className="flex flex-col h-[calc(100%-4rem)] overflow-y-auto">
            <div className="flex-1 py-4">
              <div className="px-3 py-2">
                <h2 className="mb-2 px-4 text-xs font-semibold tracking-tight text-muted-foreground">PRINCIPAL</h2>
              ...
              <div className="px-3 py-2 mt-6">
                <h2 className="mb-2 px-4 text-xs font-semibold tracking-tight text-muted-foreground">CONFIGURACIÓN</h2>
                <div className="space-y-1">
